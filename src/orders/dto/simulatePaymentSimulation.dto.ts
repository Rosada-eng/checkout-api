import { ISimulatePaymentSimulationDTO } from "./simulatePaymentSimulation.dto.d";
import { IsString, Length, IsNumber } from 'class-validator';
import { Transform } from 'class-transformer';
import { ApiProperty } from '@nestjs/swagger';

export class SimulatePaymentSimulationDTO implements ISimulatePaymentSimulationDTO {
    @IsString()
    @Transform(({ value }) => {
